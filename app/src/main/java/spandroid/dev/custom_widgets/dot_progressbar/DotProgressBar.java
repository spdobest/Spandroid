package spandroid.dev.custom_widgets.dot_progressbar;
...
public class DotProgressBar extends View {
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            setStartColor(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            setEndColor(ContextCompat.getColor(getContext(), R.color.colorPrimary));
