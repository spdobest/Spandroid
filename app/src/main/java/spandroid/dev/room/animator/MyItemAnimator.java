package spandroid.dev.room.animator;
...
public class MyItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        final RoomAdapter.MyViewHolder holder = (RoomAdapter.MyViewHolder) newHolder;
        ...
        ObjectAnimator oldTextRotate = ObjectAnimator.ofFloat(holder.radioItem, View.ROTATION_X, 0, 90);
        ObjectAnimator newTextRotate = ObjectAnimator.ofFloat(holder.radioItem, View.ROTATION_X, -90, 0);
        oldTextRotate.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationStart(Animator animation) {
                holder.radioItem.setText(preColorTextInfo.text);
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                holder.radioItem.setText(postColorTextInfo.text);
            }
        });
    ...
    private class ColorTextInfo extends ItemHolderInfo {
        ...
        public ItemHolderInfo setFrom(RecyclerView.ViewHolder holder) {
            if (holder instanceof RoomAdapter.MyViewHolder) {
                RoomAdapter.MyViewHolder colorViewHolder = (RoomAdapter.MyViewHolder) holder;
                color = ((ColorDrawable) colorViewHolder.itemView.getBackground()).getColor();
                text = (String) colorViewHolder.radioItem.getText();
            }
