 ...
 */
abstract class NestedExpandRecyclerAdapter(internal var listModel: List<NestedRecyclerModel>) : RecyclerView.Adapter<NestedExpandRecyclerAdapter.MyViewHolder>() {
